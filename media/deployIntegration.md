It is assumed that you have a running Camel K instance to which you are connected to.

![Camel K Start Integration menu](../images/camelk-start-integration-popup-menu.jpg){.imageRight}
